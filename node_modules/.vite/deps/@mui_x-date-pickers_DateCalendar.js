...
} from "./chunk-HTBOULM3.js";
import {
  PickerAdapterContext
} from "./chunk-O5R3TV7H.js";
import {
...
var useIsDateDisabled = ({
  ...
  return React11.useCallback((day) => validateDate({
    adapter,
    value: day,
    timezone,
    props: {
...
var useCalendarState = (params) => {
  ...
  const adapter = usePickerAdapter();
  const reducerFn = React12.useRef(createCalendarStateReducer(Boolean(reduceAnimations), adapter)).current;
  ...
  const [calendarState, dispatch] = React12.useReducer(reducerFn, {
    isMonthSwitchingAnimating: false,
  ...
  const onMonthSwitchingAnimationEnd = React12.useCallback(() => {
    dispatch({
...
var usePickerPrivateContext = () => React14.useContext(PickerPrivateContext);
...
function usePickerDayOwnerState(parameters) {
  ...
  return React15.useMemo(() => _extends({}, pickerOwnerState, {
    day,
...
function WrappedDay(_ref) {
  ...
  const isOutsideCurrentMonth = React19.useMemo(() => adapter.getMonth(day) !== currentMonthNumber, [adapter, day, currentMonthNumber]);
  const ownerState = usePickerDayOwnerState({
    day,
    selected: isSelected,
    disabled: isDisabled,
...
function DayCalendar(inProps) {
  ...
  const validSelectedDays = React19.useMemo(() => selectedDays.filter((day) => !!day).map((day) => adapter.startOfDay(day)), [adapter, selectedDays]);
  ...
  return (0, import_jsx_runtime5.jsxs)(PickersCalendarDayRoot, {
    ...
    children: [(0, import_jsx_runtime5.jsxs)(PickersCalendarDayHeader, {
      ...
      }), getWeekdays(adapter, now).map((weekday, i) => (0, import_jsx_runtime5.jsx)(PickersCalendarWeekDayLabel, {
        variant: "caption",
        role: "columnheader",
...
var MonthCalendarButton = React20.memo(function MonthCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
var _excluded7 = ["autoFocus", "className", "currentMonth", "classes", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "shouldDisableMonth", "readOnly", "disableHighlightToday", "onMonthFocus", "hasFocus", "onFocusedViewChange", "monthsPerRow", "timezone", "gridLabelId", "slots", "slotProps"];
...
true ? MonthCalendar.propTypes = {
  ...
  currentMonth: import_prop_types2.default.object,
  /**
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime10.jsxs)(React27.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime10.jsxs)(React27.Fragment, {
  children: [(0, import_jsx_runtime10.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime10.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
